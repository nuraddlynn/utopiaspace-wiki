...
:is(main, .contents, .page-contents, .v-main):has(.utopia-roles-scope) {
  background: var(--utopia-page-bg);
  color: var(--utopia-text);
  padding: 28px;
  border-radius: 8px;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-roles-scope) h1 {
  color: var(--utopia-text);
  font-size: 38px;
  line-height: 1.1;
  letter-spacing: 0;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-roles-scope) h2 {
  color: var(--utopia-text);
  border-top: 1px solid var(--utopia-border);
  font-size: 22px;
  line-height: 1.3;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-roles-scope) p,
:is(main, .contents, .page-contents, .v-main):has(.utopia-roles-scope) li {
  color: var(--utopia-muted);
  font-size: 15px;
  line-height: 1.6;
}

:is(main, .contents, .page-contents, .v-main):has(.utopia-roles-scope) > p:first-of-type {
  max-width: 780px;
  font-size: 18px;
}

:is(main, .contents, .page-contents, .v-main):has(.utopia-roles-scope) .utopia-roles-actions {
  display: flex;
  flex-wrap: wrap;
  gap: 10px;
  margin: 20px 0 28px;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-roles-scope) .utopia-roles-actions a {
  display: inline-flex;
  align-items: center;
  min-height: 36px;
  padding: 8px 14px;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-roles-scope) .utopia-roles-actions a:hover {
  background: var(--utopia-brand-blue-hover);
  border-color: var(--utopia-brand-blue-hover);
  text-decoration: none;
}

:is(main, .contents, .page-contents, .v-main):has(.utopia-roles-scope) .utopia-roles-grid {
  display: grid;
  grid-template-columns: repeat(3, minmax(0, 1fr));
  gap: 16px;
}

:is(main, .contents, .page-contents, .v-main):has(.utopia-roles-scope) .utopia-roles-grid section {
  background: var(--utopia-surface);
  border: 1px solid var(--utopia-border);
  border-radius: 8px;
  box-shadow: var(--utopia-shadow);
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-roles-scope) .utopia-roles-grid h3 {
  color: var(--utopia-text);
  font-size: 16px;
  line-height: 1.35;
  margin: 0 0 8px;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-roles-scope) .utopia-roles-grid p {
  margin: 0;
}

:is(main, .contents, .page-contents, .v-main):has(.utopia-roles-scope) .utopia-roles-flow,
:is(main, .contents, .page-contents, .v-main):has(.utopia-roles-scope) .utopia-roles-table {
  overflow: hidden;
  background: var(--utopia-surface);
  border: 1px solid var(--utopia-border);
  border-radius: 8px;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-roles-scope) .utopia-roles-flow div {
  display: grid;
  grid-template-columns: 44px 1fr;
  gap: 14px;
  align-items: center;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-roles-scope) .utopia-roles-flow div:nth-child(odd) {
  background: var(--utopia-row-soft);
}

:is(main, .contents, .page-contents, .v-main):has(.utopia-roles-scope) .utopia-roles-flow div:last-child {
  border-bottom: 0;
}

:is(main, .contents, .page-contents, .v-main):has(.utopia-roles-scope) .utopia-roles-flow strong {
  display: inline-flex;
  align-items: center;
  justify-content: center;
  width: 30px;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-roles-scope) .utopia-roles-flow span {
  color: var(--utopia-text);
  font-size: 15px;
  line-height: 1.5;
}
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-roles-scope) .utopia-roles-head {
  color: var(--utopia-muted);
  background: transparent;
  border-bottom: 1px solid var(--utopia-border);
  font-size: 12px;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-roles-scope) .utopia-roles-table strong,
:is(main, .contents, .page-contents, .v-main):has(.utopia-roles-scope) .utopia-roles-table p {
  margin: 0;
  padding: 16px 20px;
  border-bottom: 1px solid var(--utopia-border);
}

:is(main, .contents, .page-contents, .v-main):has(.utopia-roles-scope) .utopia-roles-table > strong:nth-of-type(odd),
:is(main, .contents, .page-contents, .v-main):has(.utopia-roles-scope) .utopia-roles-table > p:nth-of-type(odd) {
  background: var(--utopia-row-soft);
}
...
@media (max-width: 720px) {
  ...
  :is(main, .contents, .page-contents, .v-main):has(.utopia-roles-scope) .utopia-roles-head:nth-child(2) {
    display: none;
  }
}

:is(main, .contents, .page-contents, .v-main):has(.utopia-settings-scope) {
  background: var(--utopia-page-bg);
  color: var(--utopia-text);
  padding: 28px;
  border-radius: 8px;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-settings-scope) h1 {
  color: var(--utopia-text);
  font-size: 38px;
  line-height: 1.1;
  letter-spacing: 0;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-settings-scope) h2 {
  color: var(--utopia-text);
  border-top: 1px solid var(--utopia-border);
  font-size: 22px;
  line-height: 1.3;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-settings-scope) p,
:is(main, .contents, .page-contents, .v-main):has(.utopia-settings-scope) li {
  color: var(--utopia-muted);
  font-size: 15px;
  line-height: 1.6;
}

:is(main, .contents, .page-contents, .v-main):has(.utopia-settings-scope) > p:first-of-type {
  max-width: 780px;
  font-size: 18px;
}

:is(main, .contents, .page-contents, .v-main):has(.utopia-settings-scope) .utopia-settings-actions {
  display: flex;
  flex-wrap: wrap;
  gap: 10px;
  margin: 20px 0 28px;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-settings-scope) .utopia-settings-actions a {
  display: inline-flex;
  align-items: center;
  min-height: 36px;
  padding: 8px 14px;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-settings-scope) .utopia-settings-actions a:hover {
  background: var(--utopia-brand-blue-hover);
  border-color: var(--utopia-brand-blue-hover);
  text-decoration: none;
}

:is(main, .contents, .page-contents, .v-main):has(.utopia-settings-scope) .utopia-settings-grid {
  display: grid;
  grid-template-columns: repeat(3, minmax(0, 1fr));
  gap: 16px;
}

:is(main, .contents, .page-contents, .v-main):has(.utopia-settings-scope) .utopia-settings-grid section {
  background: var(--utopia-surface);
  border: 1px solid var(--utopia-border);
  border-radius: 8px;
  box-shadow: var(--utopia-shadow);
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-settings-scope) .utopia-settings-grid h3 {
  color: var(--utopia-text);
  font-size: 16px;
  line-height: 1.35;
  margin: 0 0 8px;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-settings-scope) .utopia-settings-grid p {
  margin: 0;
}

:is(main, .contents, .page-contents, .v-main):has(.utopia-settings-scope) .utopia-settings-flow,
:is(main, .contents, .page-contents, .v-main):has(.utopia-settings-scope) .utopia-settings-table {
  overflow: hidden;
  background: var(--utopia-surface);
  border: 1px solid var(--utopia-border);
  border-radius: 8px;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-settings-scope) .utopia-settings-flow div {
  display: grid;
  grid-template-columns: 44px 1fr;
  gap: 14px;
  align-items: center;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-settings-scope) .utopia-settings-flow div:nth-child(odd) {
  background: var(--utopia-row-soft);
}

:is(main, .contents, .page-contents, .v-main):has(.utopia-settings-scope) .utopia-settings-flow div:last-child {
  border-bottom: 0;
}

:is(main, .contents, .page-contents, .v-main):has(.utopia-settings-scope) .utopia-settings-flow strong {
  display: inline-flex;
  align-items: center;
  justify-content: center;
  width: 30px;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-settings-scope) .utopia-settings-flow span {
  color: var(--utopia-text);
  font-size: 15px;
  line-height: 1.5;
}
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-settings-scope) .utopia-settings-head {
  color: var(--utopia-muted);
  background: transparent;
  border-bottom: 1px solid var(--utopia-border);
  font-size: 12px;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-settings-scope) .utopia-settings-table strong,
:is(main, .contents, .page-contents, .v-main):has(.utopia-settings-scope) .utopia-settings-table p {
  margin: 0;
  padding: 16px 20px;
  border-bottom: 1px solid var(--utopia-border);
}

:is(main, .contents, .page-contents, .v-main):has(.utopia-settings-scope) .utopia-settings-table > strong:nth-of-type(odd),
:is(main, .contents, .page-contents, .v-main):has(.utopia-settings-scope) .utopia-settings-table > p:nth-of-type(odd) {
  background: var(--utopia-row-soft);
}
...
@media (max-width: 720px) {
  ...
  :is(main, .contents, .page-contents, .v-main):has(.utopia-settings-scope) .utopia-settings-head:nth-child(2) {
    display: none;
  }
}

:is(main, .contents, .page-contents, .v-main):has(.utopia-architecture-scope) {
  background: var(--utopia-page-bg);
  color: var(--utopia-text);
  padding: 28px;
  border-radius: 8px;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-architecture-scope) h1 {
  color: var(--utopia-text);
  font-size: 38px;
  line-height: 1.1;
  letter-spacing: 0;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-architecture-scope) h2 {
  color: var(--utopia-text);
  border-top: 1px solid var(--utopia-border);
  font-size: 22px;
  line-height: 1.3;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-architecture-scope) p,
:is(main, .contents, .page-contents, .v-main):has(.utopia-architecture-scope) li {
  color: var(--utopia-muted);
  font-size: 15px;
  line-height: 1.6;
}

:is(main, .contents, .page-contents, .v-main):has(.utopia-architecture-scope) > p:first-of-type {
  max-width: 860px;
  font-size: 18px;
}

:is(main, .contents, .page-contents, .v-main):has(.utopia-architecture-scope) .utopia-architecture-actions {
  display: flex;
  flex-wrap: wrap;
  gap: 10px;
  margin: 20px 0 28px;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-architecture-scope) .utopia-architecture-actions a {
  display: inline-flex;
  align-items: center;
  min-height: 36px;
  padding: 8px 14px;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-architecture-scope) .utopia-architecture-actions a:hover {
  background: var(--utopia-brand-blue-hover);
  border-color: var(--utopia-brand-blue-hover);
  text-decoration: none;
}

:is(main, .contents, .page-contents, .v-main):has(.utopia-architecture-scope) .utopia-architecture-grid {
  display: grid;
  grid-template-columns: repeat(3, minmax(0, 1fr));
  gap: 16px;
}

:is(main, .contents, .page-contents, .v-main):has(.utopia-architecture-scope) .utopia-architecture-grid section {
  background: var(--utopia-surface);
  border: 1px solid var(--utopia-border);
  border-radius: 8px;
  box-shadow: var(--utopia-shadow);
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-architecture-scope) .utopia-architecture-grid h3 {
  color: var(--utopia-text);
  font-size: 16px;
  line-height: 1.35;
  margin: 0 0 8px;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-architecture-scope) .utopia-architecture-grid p {
  margin: 0;
}

:is(main, .contents, .page-contents, .v-main):has(.utopia-architecture-scope) .utopia-architecture-flow,
:is(main, .contents, .page-contents, .v-main):has(.utopia-architecture-scope) .utopia-architecture-table {
  overflow: hidden;
  background: var(--utopia-surface);
  border: 1px solid var(--utopia-border);
  border-radius: 8px;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-architecture-scope) .utopia-architecture-flow div {
  display: grid;
  grid-template-columns: 44px 1fr;
  gap: 14px;
  align-items: center;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-architecture-scope) .utopia-architecture-flow div:nth-child(odd) {
  background: var(--utopia-row-soft);
}

:is(main, .contents, .page-contents, .v-main):has(.utopia-architecture-scope) .utopia-architecture-flow div:last-child {
  border-bottom: 0;
}

:is(main, .contents, .page-contents, .v-main):has(.utopia-architecture-scope) .utopia-architecture-flow strong {
  display: inline-flex;
  align-items: center;
  justify-content: center;
  width: 30px;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-architecture-scope) .utopia-architecture-flow span {
  color: var(--utopia-text);
  font-size: 15px;
  line-height: 1.5;
}
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-architecture-scope) .utopia-architecture-head {
  color: var(--utopia-muted);
  background: transparent;
  border-bottom: 1px solid var(--utopia-border);
  font-size: 12px;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-architecture-scope) .utopia-architecture-table strong,
:is(main, .contents, .page-contents, .v-main):has(.utopia-architecture-scope) .utopia-architecture-table p {
  margin: 0;
  padding: 16px 20px;
  border-bottom: 1px solid var(--utopia-border);
}

:is(main, .contents, .page-contents, .v-main):has(.utopia-architecture-scope) .utopia-architecture-table > strong:nth-of-type(odd),
:is(main, .contents, .page-contents, .v-main):has(.utopia-architecture-scope) .utopia-architecture-table > p:nth-of-type(odd) {
  background: var(--utopia-row-soft);
}
...
@media (max-width: 720px) {
  ...
  :is(main, .contents, .page-contents, .v-main):has(.utopia-architecture-scope) .utopia-architecture-head:nth-child(2) {
    display: none;
  }
}
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-api-scope) {
  background: var(--utopia-page-bg);
  color: var(--utopia-text);
  padding: 28px;
  border-radius: 8px;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-api-scope) li {
  color: var(--utopia-muted);
  font-size: 15px;
  line-height: 1.6;
}

:is(main, .contents, .page-contents, .v-main):has(.utopia-api-scope) > p:first-of-type {
  max-width: 860px;
  font-size: 18px;
}

:is(main, .contents, .page-contents, .v-main):has(.utopia-api-scope) .utopia-api-actions {
  display: flex;
  flex-wrap: wrap;
  gap: 10px;
  margin: 20px 0 28px;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-api-scope) .utopia-api-actions a {
  display: inline-flex;
  align-items: center;
  min-height: 36px;
  padding: 8px 14px;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-api-scope) .utopia-api-actions a:hover {
  background: var(--utopia-brand-blue-hover);
  border-color: var(--utopia-brand-blue-hover);
  text-decoration: none;
}
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-api-scope) .utopia-api-grid section {
  background: var(--utopia-surface);
  border: 1px solid var(--utopia-border);
  border-radius: 8px;
  box-shadow: var(--utopia-shadow);
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-api-scope) .utopia-api-grid h3 {
  color: var(--utopia-text);
  font-size: 16px;
  line-height: 1.35;
  margin: 0 0 8px;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-api-scope) .utopia-api-table {
  overflow: hidden;
  background: var(--utopia-surface);
  border: 1px solid var(--utopia-border);
  border-radius: 8px;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-api-scope) .utopia-api-flow div {
  display: grid;
  grid-template-columns: 44px 1fr;
  gap: 14px;
  align-items: center;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-api-scope) .utopia-api-flow div:nth-child(odd) {
  background: var(--utopia-row-soft);
}

:is(main, .contents, .page-contents, .v-main):has(.utopia-api-scope) .utopia-api-flow div:last-child {
  border-bottom: 0;
}

:is(main, .contents, .page-contents, .v-main):has(.utopia-api-scope) .utopia-api-flow strong {
  display: inline-flex;
  align-items: center;
  justify-content: center;
  width: 30px;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-api-scope) .utopia-api-flow span {
  color: var(--utopia-text);
  font-size: 15px;
  line-height: 1.5;
}
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-api-scope) .utopia-api-head {
  color: var(--utopia-muted);
  background: transparent;
  border-bottom: 1px solid var(--utopia-border);
  font-size: 12px;
...
:is(main, .contents, .page-contents, .v-main):has(.utopia-api-scope) .utopia-api-table strong,
:is(main, .contents, .page-contents, .v-main):has(.utopia-api-scope) .utopia-api-table p {
  margin: 0;
  padding: 16px 20px;
  border-bottom: 1px solid var(--utopia-border);
}

:is(main, .contents, .page-contents, .v-main):has(.utopia-api-scope) .utopia-api-table > strong:nth-of-type(odd),
:is(main, .contents, .page-contents, .v-main):has(.utopia-api-scope) .utopia-api-table > p:nth-of-type(odd) {
  background: var(--utopia-row-soft);
}
...
@media (max-width: 720px) {
  ...
  :is(main, .contents, .page-contents, .v-main):has(.utopia-api-scope) .utopia-api-head:nth-child(2) {
    display: none;
  }
}
